...
function Todo() {
  ...
  useEffect(()=>{getTodo()},[]) //渲染一次就好，不然直接戳爆
        ...
        <div className="conatiner todoListPage vhContainer">
          <div className="todoList_Content">
            <div className="inputBox">
              <input type="text" placeholder="請輸入待辦事項" value={addTodo} onChange={(e)=>{
            ...
            <div className="todoList_list">
              <ul className="todoList_tab">
                <li>
                  <a href="#" className={todoType === "all"?"active":""} onClick={(e)=>todoTypeChange(e,"all")}>
                    全部
                  </a>
                </li>
                <li>
                  <a href="#" className={todoType === "active"?"active":""} onClick={(e)=>todoTypeChange(e,"active")}>待完成</a>
                </li>
                <li>
                  <a href="#" className={todoType === "completed"?"active":""} onClick={(e)=>todoTypeChange(e,"completed")}>已完成</a>
                </li>
              </ul>
              <div className="todoList_items">
                  ...
                  {filterTodo.map((item)=>(
                    <li key={item.id}>
                        ...
                        {(isEditing === item.id)?(
                            ...
                            <button className="update-btn" onClick={()=>UpdateTodo(item.id, editTodo)}>確認</button>
                            <button className="delete-btn" onClick={()=>setIsEditing(null)}>取消</button>
                            </>
                            ):(
                                <>
                                <label className="todoList_label">
                              ...
                              <button className= "update-btn" onClick={()=>setIsEditing(item.id)}>更改</button>
                              <button className= "delete-btn" onClick={()=>deleteItems(item.id)}>刪除</button>
                              </>
                ...
                <div className="todoList_statistics">
                  ...
                  <a href="#" onClick={clearCompleted}>清除已完成項目</a>
                </div>
              </div>
            </div>
          </div>
